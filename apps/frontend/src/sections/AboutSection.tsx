...
export default function AboutSection() {
  ...
  return (
    <section id="about" className="py-14 bg-white md:py-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <h2 className="text-2xl md:text-4xl font-bold text-gray-900">تعرف على مؤسسة أطر الغد</h2>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-10 items-center">
          <motion.div
            ...
            variants={fadeInUp}
          >
            <p className="text-gray-600 leading-8 md:leading-loose text-base md:text-lg mb-5 md:mb-6">
            ...
            <p className="text-gray-600 leading-8 md:leading-loose text-base md:text-lg">
          ...
          <motion.div
            ...
            className="space-y-4"
          >
            <div className="bg-gradient-to-br from-[#4A9B8E]/5 to-[#6BC4B2]/5 rounded-2xl p-5 md:p-6 border border-[#4A9B8E]/10">
