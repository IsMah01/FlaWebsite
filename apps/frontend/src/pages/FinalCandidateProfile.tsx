...
export default function FinalCandidateProfile() {
  ...
  return <div className="candidate-orange-theme min-h-screen bg-[#F4F8F7]" lang="ar" dir="rtl"><Navbar /><main className="mx-auto max-w-5xl px-3 pb-12 pt-20 sm:px-6 sm:pt-24">
