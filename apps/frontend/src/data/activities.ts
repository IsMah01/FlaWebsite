...
export const activities: ActivityData[] = [
  {
    ...
    feedback: [
      {
        name: "سفيان محسن",
        role: "طالب دكتوراه في القانون الخاص",
        comment: `سواء قبل قدومي للأكاديمية أو حال مشاركتي في
فعالياتها، لم تمر لحظة واحدة إلا وسمعت أحدهم يقول:
"الأكاديمية تجربة تعاش ولا تحكى"، بداية لم أستوعب هذه
العبارة، ظنا مني أن الأكاديمية ستكون كباقي التجارب التي
عشتها، وسيكون من السهل جدا وصفها بعد أن نخوضها.
أدركت أن الأكاديمية تجربة لا يمكن وصفها أو نقلها: ما عشناه
لا يَنْقالُ باللغة ولا بضروب البيان المعتادة، هذا الزخم العظيم
لما مررنا به يهزم قدرتنا على إحاطته بالبوح من دون أن تُزاح
كل فكرة أو ومضة أو صورة أو لحظة أختها على مكانها في
الذاكرة.

أيقنت أن الأكاديمية هي تجربة رحبة متسعة لا تحددها حدود،
بينما الكلمات قاصرة عن الإحاطة بمعانيها وأسرارها، وبالتالي
فإن الكلمات غطاء للحقيقة و ستر لها، فأي كلمة نقولها هي خيانة للأكادمية لأنها لن توفي أبداً للتجربة حقها.
فأمام سحر الأكاديمية  الأخاذ يتلاشى اللفظ و المعنى و العبارة، و يفقد كل منهم تلاقته و  رونقه و توسعه. و أمام ضياء الأكاديمية البهي تعمى الكلمات والخواطر والعبارات وتصبح قاصرة عن الإحاطة بالمعاني والأسرار و تعجز عن استيعاب الرؤية كاملة و عن التعبير عن مكنونها. وأمام
اتساع الأكاديمية ورحابتها لا تملك العبارة إلا أن تضيق وتحتضر،
حتى تلفظ أنفاس النزع الأخير ...
فعلا، الأكاديمية تجربة تعاش ولا تحكى.
ومن ذاق عرف!`,
      ...
      },
      {
        ...
        comment: `تنتهي الأكاديمية ويقعد حنينك لأيامها
أعمق من حماسك قبيل بدوها، ساعتها
تدرك عمق اللحظات التي جمعتك بسفرائها،
بخطبائها، بمناظريها ولاسيما بمحاضريها
وضيوفها، تتذكر رونق الصباحيات حيث
ازداد المرء من الذكرى وتعاودك ذكريات
نقاشات وحوارات هادفة خضتها، ومناظرات
وندوات ومحاضرات تفتح آفاق فكرك،
وتوسع مداركك، لتخرجك من براثن الجهل
و وحل التفاهة إلى أنوار التعلم والرسالية`,
        image: "/images/logo.png",
      },
    ],
  },
