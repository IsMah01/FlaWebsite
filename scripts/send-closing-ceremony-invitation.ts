...
const reportPath = process.env.CLOSING_INVITATION_REPORT_PATH
  || "storage/closing-ceremony-email-report-v2-malaki.csv";
const sentMarkerPath = process.env.CLOSING_INVITATION_SENT_MARKER
  || "storage/.closing-ceremony-invitation-v2-malaki-sent";
...
const subject = "دعوة لحضور الحفل الختامي لأكاديمية أطر الغد – دورة الأثر – سينما ملكي سلا";
// v2: corrected venue (Cinéma Malaki, Salé) and venue highlighted in the subject/body.
const campaignKey = "closing-ceremony-2026-08-23-v2-malaki";
